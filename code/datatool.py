import os
from utils import DownloadUrl, DataParse
...
class YELP(object):
    ...
    def __init__(self, root, train=True, download=False):
        ...
        self.train_set = self.GetData(train=True)
        self.test_set = self.GetData(train=False)
    ...
    def Download(self):
        ...
        DownloadUrl(self.url, self.root, self.filename, self.tgz_md5)
    ...
    def GetData(self, train=True):
        ...
        Args:
            ...
            shuffle (bool, optional): If true, return the dataset in random order, otherwise
                return the dataset in the original order.
